...
import { HelpCircle, Plus, Edit2, Trash2, ChevronDown, ChevronUp, Eye } from "lucide-react";
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-extrabold text-navy font-[family-name:var(--font-poppins)]">FAQ Management</h1>
